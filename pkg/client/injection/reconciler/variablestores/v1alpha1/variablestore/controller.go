...
import (
	...
	versionedscheme "github.com/vincentpli/cel-tekton/pkg/client/clientset/versioned/scheme"
	client "github.com/vincentpli/cel-tekton/pkg/client/injection/client"
	variablestore "github.com/vincentpli/cel-tekton/pkg/client/injection/informers/variablestores/v1alpha1/variablestore"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "variablestores.samples.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	variablestoreInformer := variablestore.Get(ctx)

	lister := variablestoreInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "samples.knative.dev.VariableStore"),
	)
